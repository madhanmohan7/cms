...
class CommuitiesScreen extends StatefulWidget {
  const CommuitiesScreen({super.key});

  @override
  State<CommuitiesScreen> createState() => _CommuitiesScreenState();
}

class _CommuitiesScreenState extends State<CommuitiesScreen> {
          ...
          child: WillPopScope(
            ...
            child: ResponsiveBuilder(
              ...
              desktop: (context, constraints) {
                return const CommunitiesDesktopUi();
              },
            ),
          )
      ),
