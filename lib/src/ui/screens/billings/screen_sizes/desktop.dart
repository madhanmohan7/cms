...
class BillingsDesktopUi extends StatefulWidget {
  const BillingsDesktopUi({super.key});

  @override
  State<BillingsDesktopUi> createState() => _BillingsDesktopUiState();
}

class _BillingsDesktopUiState extends State<BillingsDesktopUi> {
  ...
  Future<void> exportToCSV(BuildContext context,
      List<Billings> billings) async {
    ...
    final String fileName = 'Billings_$formattedDate.csv';
    ...
    List<List<String>> csvData = [
      ...
      [
        ...
        item.stationId ?? '',
        '${formatter.format(
            DateTime.parse(item.startTime.toString()))} - ${formatterTime
            .format(DateTime.parse(item.endTime.toString()))}',
        // DateTime formatting
        item.energyConsumed.toString(),
        item.cost.toString(),
      ]),
    ];
    ...
    if (kIsWeb) {
      ...
      final anchor = html.AnchorElement(
          href: "data:text/csv;charset=utf-8,$encodedFileContents")
      ...
      children: [
        ...
        TableRow(
          ...
          children: [
            ...
            _buildTableCell('Power Consumed (Wh)', isHeader: true),
        ...
        ..._getPaginatedBillings().asMap().entries.map((entry) {
          ...
          return TableRow(
            ...
            children: [
              ...
              _buildTableCell(bill.energyConsumed.toString()),
              _buildTableCell(bill.cost.toString()),
