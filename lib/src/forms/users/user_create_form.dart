...
class CreateUserFormScreen extends StatefulWidget {
  ...
  @override
  _CreateUserFormScreenState createState() => _CreateUserFormScreenState();
}
...
class _CreateUserFormScreenState extends State<CreateUserFormScreen> {
  ...
  void _filterCommunitiesBasedOnRole() {
    if (userRole == "sub-admin" && userCommunity != null) {
      ...
      setState(() {
        selectedCommunity = userCommunities.isNotEmpty ? userCommunities.first : null;
        widget.user.organizationName = selectedCommunity?.organizationName ?? '';
        widget.user.organizationId = selectedCommunity?.organizationId;
      });
    }
