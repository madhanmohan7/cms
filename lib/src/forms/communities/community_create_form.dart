...
class CreateCommunityFormScreen extends StatefulWidget {
  ...
  const CreateCommunityFormScreen({
    Key? key,
  ...
  @override
  _CreateCommunityFormScreenState createState() => _CreateCommunityFormScreenState();
}

class _CreateCommunityFormScreenState extends State<CreateCommunityFormScreen> {
  String? _pdfFileName;
