...
class EditChargerFormScreen extends StatefulWidget {
  ...
  @override
  _EditChargerFormScreenState createState() => _EditChargerFormScreenState();
}

class _EditChargerFormScreenState extends State<EditChargerFormScreen> {
  String? userRole;
  int? userCommunity;
  ...
  void initState() {
    ...
    widget.charger.pointType = widget.charger.pointType;
  ...
  void _setSelectedCommunity() {
    ...
    selectedCommunity = chargerCommunities.firstWhere(
          (community) => community.organizationId == widget.charger.organizationId,
